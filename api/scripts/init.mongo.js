...
* connection string is supplied in the command line. For example: * localhost:
* mongo issuetracker scripts/init.mongo.js
* Atlas:
* mongo mongodb+srv://user:pwd@xxx.mongodb.net/issuetracker 
scripts/init.mongo.js * MLab:
...
const issuesDB = [
  {
    ...
    owner: 'Ravan',
    effort: 5,
    created: new Date('2020-08-04'),
    due: undefined,
    title: 'Error in console when clicking Add',
    description: 'Step to recreate the problem:'
